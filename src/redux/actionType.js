...
export const SET_SUBSCRIBTION_STATUS = "SET_SUBSCRIBTION_STATUS";
...
export const CHANNELS_VIDOES_SUCCESS = "CHANNELS_VIDOES_SUCCESS";
export const CHANNELS_VIDOES_FAIL = "CHANNELS_VIDOES_FAIL";
export const CHANNELS_VIDOES_REQUEST = "CHANNELS_VIDOES_REQUEST";
